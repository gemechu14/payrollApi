...
const deductionController = require('../controllers/generalDeductin.js');
...
router.put('/:employeeId/:id',
    ...
    router.delete('/:id',
        middleware.protect,
        middleware.restrictTo('Companyadmin'),
        deductionController.delete_Deduction);
...
//ADD EXISTING ALLOWANCE TO ALL EMPLOYEE  UNDER SPECIFIC GRADE
router.put('/addToGrade/:gradeId/:deductionId',
    middleware.protect,
    middleware.restrictTo('Companyadmin'),
    deductionController.addExistingDeductionToAllEmployee
);
