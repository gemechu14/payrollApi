...
>>>>>>> 9a5592ec177a59f38485cd337b26603968154e07
...
async function fetchData(message) {
  ...
  try {
    ...
    const employees = await Employee.find({ companyId: message.user })
      .populate("deduction")
      .populate("allowance");
    ...
    if (getPayroll.length != 0) {
      ...
      // console.log(newpay)
      console.log(
        `Payroll processed for employee ${employee.fullname}.  `,
        payrollData
      );
